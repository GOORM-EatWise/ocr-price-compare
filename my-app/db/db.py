...
#     with col1:
#         st.write("키")
#         user_info["user_height"] = st.number_input(
#             "키를 입력해주세요", value=None, format="%.1f", step=0.1
#         )
#     with col2:
#         st.write("몸무게")
#         user_info["user_weight"] = st.number_input(
#             "몸무게를 입력해주세요", value=None, format="%.1f", step=0.1
#         )

#     col1, col2 = st.columns(2)
#     with col1:
#         st.write("나이")
#         user_info["user_age"] = st.number_input(
#             "나이를 입력해주세요", value=None, step=1
#         )
